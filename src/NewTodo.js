        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Create a React todo app"
              required
            />
          </div>
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Develop an application that interacts with the provided API in such a way that the user can accomplish all the functions the API was made for."
            />
          </div>
          <div className="form-group">
